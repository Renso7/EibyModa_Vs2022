...
namespace ApiWebPageEiby.Controllers
{
    ...
    public class DocSalidaController : ControllerBase
    {
        ...
        private readonly IDocSalidaBussnies _docSalidaBussnies;
        private readonly IMapper _mapper;

        public DocSalidaController(IMapper mapper)
        {
            _mapper = mapper;
            _docSalidaBussnies = new DocSalidaBussnies(mapper);
        }
        ...
        [HttpGet]
        [ProducesResponseType((int)HttpStatusCode.OK, Type = typeof(List<DocSalidaResponse>))]
        [ProducesResponseType((int)HttpStatusCode.BadRequest, Type = typeof(GenericResponse))]
        [ProducesResponseType((int)HttpStatusCode.InternalServerError, Type = typeof(GenericResponse))]
        public IActionResult Get()
        {
            return Ok(_docSalidaBussnies.GetAll());
        }
        ...
        {
            return Ok(_docSalidaBussnies.GetById(id));
        }
        ...
        {
            return Ok(_docSalidaBussnies.Create(request));
        }
        ...
        {
            return Ok(_docSalidaBussnies.Update(request));
        }
        ...
        {
            return Ok(_docSalidaBussnies.Delete(id));
        }
