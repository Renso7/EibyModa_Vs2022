...
namespace ApiWebPageEiby.Controllers
{
    ...
    public class KardexController : ControllerBase
    {
        ...
        private readonly IKardexBussnies _kardexBussnies;
        private readonly IMapper _mapper;

        public KardexController(IMapper mapper)
        {
            _mapper = mapper;
            _kardexBussnies = new KardexBussnies(mapper);
        }
        ...
        [HttpGet]
        [ProducesResponseType((int)HttpStatusCode.OK, Type = typeof(List<KardexResponse>))]
        [ProducesResponseType((int)HttpStatusCode.BadRequest, Type = typeof(GenericResponse))]
        [ProducesResponseType((int)HttpStatusCode.InternalServerError, Type = typeof(GenericResponse))]
        public IActionResult Get()
        {
            return Ok(_kardexBussnies.GetAll());
        }
        ...
        {
            return Ok(_kardexBussnies.GetById(id));
        }
        ...
        {
            return Ok(_kardexBussnies.Create(request));
        }
        ...
        {
            return Ok(_kardexBussnies.Update(request));
        }
        ...
        {
            return Ok(_kardexBussnies.Delete(id));
        }
